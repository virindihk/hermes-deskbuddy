...
(function (root, factory) {
  ...
  zh: {
    ...
    capturingScreen: '拖拽框选要截图的区域...',
    screenCaptureReady: '截图区域已准备好，确认后点发送',
    screenCaptureFailed: '框选截图失败',
    screenCaptureDefaultPrompt: '请简要说明屏幕内容，并指出我可能需要关注的重点。',
    attachmentReady: '附件已准备好，确认后点发送',
    attachmentFailed: '附件添加失败',
    saveSettings: '保存设定',
    choose: '选择',
    newSession: '新建会话',
    resetAll: '恢复默认',
    ...
    listeningImagePlaceholder: '打开聊天/设定时图片路径',
    thinkingImagePlaceholder: 'Hermes 思考时图片路径',
    ...
    cliConversationMode: 'Hermes CLI Session',
    apiConversationMode: '独立 API Server',
    apiBaseUrl: 'API Server 地址',
    apiBaseUrlPlaceholder: 'http://127.0.0.1:8642',
    apiConversation: 'API 会话',
  ...
  en: {
    send: 'Send',
    screenCapture: 'Select Area',
    attachFile: 'Add Attachment',
    removeAttachment: 'Remove Attachment',
    capturingScreen: 'Drag to select a screen area...',
    screenCaptureReady: 'Selected area ready. Review, then send.',
    screenCaptureFailed: 'Area capture failed',
    screenCaptureDefaultPrompt: 'Briefly describe what is on the screen and point out anything I may need to pay attention to.',
    attachmentReady: 'Attachment ready. Review, then send.',
    attachmentFailed: 'Failed to add attachment',
    ...
    listeningImagePlaceholder: 'Listen image path',
    thinkingImagePlaceholder: 'Hermes thinking image path',
    ...
    cliConversationMode: 'Hermes CLI Session',
    apiConversationMode: 'Independent API Server',
  ...
  ja: {
    ...
    capturingScreen: '撮影する範囲をドラッグして選択してください...',
    screenCaptureReady: '選択範囲のスクリーンショット準備完了。確認して送信してください',
    screenCaptureFailed: '範囲スクリーンショットに失敗しました',
    screenCaptureDefaultPrompt: '画面の内容を簡潔に説明し、注意すべき点があれば指摘してください。',
    attachmentReady: '添付準備完了。確認して送信してください',
    attachmentFailed: '添付の追加に失敗しました',
    saveSettings: '設定を保存',
    choose: '選択',
    newSession: '新しいセッション',
    resetAll: 'デフォルトに戻す',
    ...
    listeningImagePlaceholder: 'チャット/設定を開いた時の画像パス',
    thinkingImagePlaceholder: 'Hermes 思考時画像のパス',
  ...
  ko: {
    ...
    capturingScreen: '캡처할 영역을 드래그해 선택하세요...',
    screenCaptureReady: '선택한 영역이 준비되었습니다. 확인 후 보내세요',
    screenCaptureFailed: '영역 캡처 실패',
    screenCaptureDefaultPrompt: '화면 내용을 간단히 설명하고 제가 주의해야 할 부분이 있으면 알려주세요.',
    attachmentReady: '첨부가 준비되었습니다. 확인 후 보내세요',
    attachmentFailed: '첨부 추가 실패',
    saveSettings: '설정 저장',
    choose: '선택',
    newSession: '새 세션',
    resetAll: '기본으로',
    ...
    listeningImagePlaceholder: '채팅/설정 열림 상태 이미지 경로',
    thinkingImagePlaceholder: 'Hermes 생각 중 이미지 경로',
    happyImagePlaceholder: '완료 이미지 경로',
    provider: '제공자',
    customProvider: '직접 입력...',
    model: '모델',
    customModel: '직접 입력...',
    modelPlaceholder: '예: gpt-4o, claude-sonnet-4',
    conversationMode: '대화 모드',
    cliConversationMode: 'Hermes CLI Session',
    apiConversationMode: '독립 API Server',
    apiBaseUrl: 'API Server URL',
    apiBaseUrlPlaceholder: 'http://127.0.0.1:8642',
    apiConversation: 'API 대화',
